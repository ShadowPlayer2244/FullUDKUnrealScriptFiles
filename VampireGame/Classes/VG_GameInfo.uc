...
//=============================================================================
class VG_GameInfo extends SimpleGame;
...
{
	local VG_InventoryManager VG_InventoryManager;
	...
	if (DefaultWeaponArchetype != None)
	{
		...
		VG_InventoryManager = VG_InventoryManager(P.InvManager);
		if (VG_InventoryManager != None)
		{
			// Create the inventory from the archetype
			VG_InventoryManager.CreateInventoryArchetype(DefaultWeaponArchetype, false);
		}
	}
}
